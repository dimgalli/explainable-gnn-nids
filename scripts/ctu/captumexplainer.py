...
parser = argparse.ArgumentParser(description='Train and test CaptumExplainer algorithm')
...
parser.add_argument('--scores', type=str, required=True, help='path to save the CaptumExplainer algorithm scores')
